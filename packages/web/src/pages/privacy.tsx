...
const Privacy = () => {
  return <SiteLayout>
    <BackTop/>
    <Title>GENERAL PRIVACY AND EU GDPR POLICY</Title>
    <Title level={3}>Introduction</Title>
    <Paragraph type="secondary">Effective updated date: June 20, 2020</Paragraph>
    <Paragraph>
      Evermod (“us”, “we”, or “our”) operates the https://evermod.ml, https://evermod.vercel.app websites (hereinafter referred to as the “Service”).
    </Paragraph>
    <Paragraph>
    ...
    <Anchor affix={false}>
      <Anchor.Link href="#what-is-gdpr" title="What Is The GDPR" />
      <Anchor.Link href="#what-data-we-collect" title="What Data We Collect and How We Collect It" />
      <Anchor.Link href="#legal-basis" title="Legal Basis for Processing the Data and Key Principles of Data Usage and Storage in our company"/>
      <Anchor.Link href="#your-rights" title="Your Rights"/>
      <Anchor.Link href="#tracking" title="Tracking & Cookies Data"/>
      <Anchor.Link href="#service" title="Service Providers"/>
      <Anchor.Link href="#link-to-other" title="Links To Other Sites"/>
      <Anchor.Link href="#final-provisions" title="Final Provisions"/>
    </Anchor>
    <Title level={2} id="what-is-gdpr">
      What Is The GDPR
    </Title>
    <Paragraph>
    ...
    <Title level={2} id="what-data-we-collect">
    ...
    <Title level={2} id="legal-basis">
      Legal Basis for Processing the Data and Key Principles of Data Usage and Storage
    </Title>
    <Paragraph>
      Using Evermod services to manage your customers’ data means that you have engaged Evermod as a data processor to carry out certain processing activities on your behalf.
    </Paragraph>
    <Paragraph>
      ...
      Additionally, Evermod acts as the data controller of the personal data we collect about you, our customer, in relations with its contractors.
    <ul>
      <li>
    ...
    <ol>
      ...
      <li>
        Making sure that your personal data and Evermod systems are safe and secure.
      </li>
      <li>
    ...
    <ul>
      <li>
        <Text strong>Security Measures.</Text> We confirm that Evermod aims to access the appropriate level of security to cover all possible risks presented by processing, in particular from accidental or unlawful destruction, loss, unauthorized disclosure, etc.
        <ul>
          <li>
            Any natural person acting under the authority of Evermod either as the controller or the processor who has access to personal data does not process them except on instructions from the controller, unless he or she is required to do so by law.
          </li>
          <li>
      ...
      <li>
        <Text strong>Sharing and Disclosing Your Personal Data.</Text> We retain access to all personal information that we have collected from you or about you. Once in our possession, we will be responsible for that information and that information will be subject to any privacy terms or policies that we have in place.
      </li>
    ...
    <ul>
      <li>What personal data we collect and process about you;</li>
      <li>The purpose and location of processing;</li>
      <li>The categories of personal data concerned;</li>
      <li>The recipients to whom the personal data has been/will be disclosed;</li>
      ...
      <li>What measures we put in place to provide you with these rights.</li>
    </ul>
    <Paragraph>
      Also, it is important to list your rights as a Data Subject related to your data maintenance/amendments:
    </Paragraph>
    <ul>
      <li>The data subject has the right to obtain from the controller without undue delay the rectification of inaccurate personal data concerning him or her;</li>
      <li>Right to obtain the erasure of personal data from the controller;</li>
      <li>Right to obtain restriction of processing from the controller;</li>
    ...
    <ul>
      <li>
        Email: max.slipenko@gmail.com
      </li>
    </ul>
    <Title level={2} id="tracking">
    ...
    <Title level={2} id="service">Links To Other Sites</Title>
    <Paragraph>
    ...
    <Title level={2} id="final-provisions">
      Final Provisions
    </Title>
    <Paragraph>
      As the controller of your personal data, Evermod is committed to respecting all your rights under the GDPR. If you have any questions or feedback, please reach out to our Data Protection Officer (DPO) by email at max.slipenko@gmail.com.
    </Paragraph>
    <Paragraph>
